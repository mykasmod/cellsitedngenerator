...
public class ExcelFileServiceImpl implements ExcelFileService {
	...
	HashMap<String, String> btsNameBTSDNMap = WorksheetUtil.readWorksheetMap(
		workBook, Constants.TWO_G_BTS_NAME_CELL_INDEX,
		Constants.TWO_G_BTS_DN_CELL_INDEX, Constants.TWO_G_SHEET_INDEX);
